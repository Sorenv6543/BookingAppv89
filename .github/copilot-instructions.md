...
- Turn bookings: `booking_type === 'turn'` means same-day short stays; `validateTurnBooking` in [src/utils/businessLogic.ts](../src/utils/businessLogic.ts) enforces same calendar day and ≥ 1 hour duration and adds early/late time warnings.
