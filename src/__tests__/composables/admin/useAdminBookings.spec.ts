...
describe('useAdminBookings (Role-Based)', () => {
  ...
  it('should provide system-wide turn alerts for business management', () => {
    ...
    const turnBooking2: Booking = {
      ...
      property_id: 'prop2',
      owner_id: 'owner2',
      checkin_date: '2023-06-01T12:00:00Z',
      checkout_date: '2023-06-01T16:00:00Z',
      booking_type: 'turn',
      status: 'pending'
    };
  ...
  it('should provide business analytics across all properties', () => {
    ...
    const bookings: Booking[] = [
      { id: 'b1', property_id: 'p1', owner_id: 'owner1', checkin_date: '2023-06-01T11:00:00Z', checkout_date: '2023-06-01T15:00:00Z', booking_type: 'turn', status: 'pending' },
      { id: 'b2', property_id: 'p2', owner_id: 'owner2', checkin_date: '2023-06-01T11:00:00Z', checkout_date: '2023-06-01T15:00:00Z', booking_type: 'turn', status: 'scheduled' },
      { id: 'b3', property_id: 'p3', owner_id: 'owner1', checkin_date: '2023-06-01T11:00:00Z', checkout_date: '2023-06-01T15:00:00Z', booking_type: 'standard', status: 'completed' },
      { id: 'b4', property_id: 'p4', owner_id: 'owner3', checkin_date: '2023-06-01T11:00:00Z', checkout_date: '2023-06-01T15:00:00Z', booking_type: 'standard', status: 'cancelled' }
    ];
  ...
  it('should provide today urgent turns for operational priority', () => {
    ...
    const todayTurn2: Booking = {
      ...
      property_id: 'prop2',
      owner_id: 'owner2',
      checkin_date: `${today}T12:00:00Z`,
      checkout_date: `${today}T16:00:00Z`,
      booking_type: 'turn',
      status: 'pending'
    };
