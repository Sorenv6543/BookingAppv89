...
export const usePropertyStore = defineStore('property', () => {
  ...
  async function fetchProperties() {
    if (__DEV__) console.log('🔍 [PropertyStore] fetchProperties called');
    loading.value = true;
    error.value = null;
    
    try {
if (__DEV__) console.log('🔍 [PropertyStore] Starting database query...');
...
if (__DEV__) console.log('✅ [PropertyStore] Raw data from database:', data);
...
if (__DEV__) console.log('✅ [PropertyStore] Final properties map size:', properties.value.size);
    } catch (err: unknown) {
      ...
      loading.value = false;
      if (__DEV__) console.log('🔍 [PropertyStore] fetchProperties completed, loading:', loading.value);
