if (!self.define) {
  ...
  self.define = (o, s) => {
    ...
    let r = {};
    const c = (e) => i(e, t),
      l = { module: { uri: t }, exports: r, require: c };
    n[t] = Promise.all(o.map((e) => l[e] || c(e))).then((e) => (s(...e), r));
  };
}
define(["./workbox-9f98fcb8"], function (e) {
  "use strict";
  self.skipWaiting(),
    e.clientsClaim(),
    e.precacheAndRoute([{ url: "/index.html", revision: "0.au9luluogag" }], {}),
